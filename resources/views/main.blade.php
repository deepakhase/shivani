...
<div class="edu2_main_bn_wrap">
    <div id="owl-demo-main" class="owl-carousel owl-theme">
        <div class="item">
            <figure>
                <img src="{{asset('images/slider/slider1.jpg')}}" alt="slider"/>
                <figcaption>
                    <span>The Best Learning Institution</span>
                    <h2>welcome to our Tuitions</h2>
        ...
        <div class="item">
            <figure>
                <img src="{{asset('images/slider/slider2.jpg')}}" alt="slider"/>
                <figcaption>
                    <span>Opening A New World Of Education</span>
                    <h2>largest Education Tuitions</h2>
        ...
        <div class="item">
            <figure>
            <img src="{{asset('images/slider/slider3.jpg')}}" alt="slider"/>
                <figcaption>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="abt_univ_wrap">
                        ...
                        <div class="kf_edu2_heading1">
                            <h3>Welcome To Shivani Group Tuitions</h3>
                        </div>
                        <!-- HEADING 1 END-->
                ...
                <div class="col-md-6">
                    <div class="abt_univ_thumb">
                        <figure>
                            <img src="images/home-about-bg.jpg" alt="images"/>
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="kf_edu2_search_wrap toppadding20 bottompadding20">
                        ...
                        <form>
                            ...
                            <div class="edu2_serc_des">
                                <select>
                                    <option value="0" selected="select">Select Board</option>
                                    <option value="1">ICSE</option>
                                    <option value="9">CBSE</option>
                        ...
                        <ul class="bxslider">
                            <li>
                                ...
                                <div class="student_slider_des">
                                    <!-- HEADING 1 START-->
                                    <div class="kf_edu2_heading1">
                                        <h3>Our Success Students Says</h3>
                                    </div>
                                    <!-- HEADING 1 END-->
